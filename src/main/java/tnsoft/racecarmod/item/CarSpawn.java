...
public class CarSpawn extends Item implements IHasModel {

	private EntityRaceCar2.Driver driver;
	
	public CarSpawn(EntityRaceCar2.Driver driver, String name)
	{
		this.driver = driver;
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                EntityRaceCar2 entityboat = new EntityRaceCar2(worldIn, raytraceresult.hitVec.x, flag1 ? raytraceresult.hitVec.y - 0.12D : raytraceresult.hitVec.y, raytraceresult.hitVec.z);
                entityboat.setDriver(driver);
